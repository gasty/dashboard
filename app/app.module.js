...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [app_component_1.AppComponent, dashboard_component_1.DashboardComponent, authorization_component_1.AuthorizationComponent],
            providers: [{ provide: common_1.LocationStrategy, useClass: common_1.HashLocationStrategy }],
            bootstrap: [app_component_1.AppComponent],
            schemas: [authorization_module_1.AuthorizationModule]
        }), 
