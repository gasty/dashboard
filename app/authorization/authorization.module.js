...
var authorization_routes_1 = require('./authorization.routes');
var AuthorizationModule = (function () {
    ...
    AuthorizationModule = __decorate([
        core_1.NgModule({
            imports: [
                router_1.RouterModule.forChild(authorization_routes_1.MODULE_ROUTES)
            ],
            declarations: [authorization_routes_1.MODULE_COMPONENTS]
        }), 
